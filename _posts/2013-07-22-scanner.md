...
La entrega se realizará a través del `GES` antes de las **23:55:00** del día **Jueves 29 de Agosto de 2013**, debe enviar un archivo llamado `grupo.zip` conteniendo  **todas** sus clases y demás archivos indicados previamente.
